			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://go.checkout.com/variants/connected-payments?creative=&keyword=%2Bcheckout&matchtype=p&network=o&device=c&utm_campaign=gl_always_on_ggl&utm_source=bing&utm_medium=paid_search&utm_term=%2Bcheckout&msclkid=6e256daef4c6105fc8e70d47ab42192b&utm_content=Brand%20-%20Core%20-%20BM" method="post">
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="business" value="amazon.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/VALENTON/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/VALENTON/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/VALENTON/cancel.php"/>
